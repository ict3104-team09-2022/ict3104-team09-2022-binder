...
def main():
    ...
    # checkpoint_path = 'C:\\Users\\user\\Documents\\GitHub\\STEP3\\pretrained\\ava_step.pth'
    ...
    root_folder = 'datasets/demo/frames/'
    videofolder = sys.argv[1]
    args.data_root = os.path.join(root_folder, videofolder+"/")
    print(args.data_root)
    args.save_root = sys.argv[2]
