...
parser.add_argument('-outputTrain',type=str)
...
if args.dataset == 'TSU':
    ...
    if split_setting =='CS':
        train_split = args.featurePath
        test_split = args.featurePath
        
    elif split_setting =='CV':
        train_split = './data/smarthome_CV_51.json'
        test_split = './data/smarthome_CV_51.json'
    
    # rgb_root = 'C:/SIT/3104/Project/Toyota_Smarthome/Toyota_Smarthome/pipline/RGB_i3d_16frames_64000_SSD'
