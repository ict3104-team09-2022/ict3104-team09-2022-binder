...
def main(args_cli):
    ...
    if args.feature_type == 'i3d':
        from i3d.extract_i3d import ExtractI3D as Extractor
    elif args.feature_type == 'r21d':
        from r21d.extract_r21d import ExtractR21D as Extractor
    elif args.feature_type == 's3d':
        from s3d.extract_s3d import ExtractS3D as Extractor
    elif args.feature_type == 'vggish':
        from vggish.extract_vggish import ExtractVGGish as Extractor
    elif args.feature_type == 'resnet':
        from resnet.extract_resnet import ExtractResNet as Extractor
    elif args.feature_type == 'raft':
        from raft.extract_raft import ExtractRAFT as Extractor
    elif args.feature_type == 'pwc':
        from pwc.extract_pwc import ExtractPWC as Extractor
    elif args.feature_type == 'clip':
        from clip.extract_clip import ExtractCLIP as Extractor
    else:
